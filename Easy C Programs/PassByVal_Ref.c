...
/*
Note: z (equal to 7) was passed to foo by value, (which means a copy of z was passed to foo), not
by reference like x and y were done.  As such, the assignment operation was performed
